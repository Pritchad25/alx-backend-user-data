...
def users() -> str:
    """ POST /users
    This method registers new user with email
    and pswd in x-www-form-urlencoded request,
...
def login() -> str:
    """ POST /sessions
    This method creates a new session for users, stores as cookie
...
def logout() -> None:
    """ DELETE /sessions
    This method destroys session by finding session_id (key in cookie)
    Return:
...
def profile() -> str:
    """ GET /profile
    This method finds user's info by finding session_id (key in cookie)
    Return:
      - JSON payload
    """
    session_id = request.cookies.get('session_id')
...
def get_reset_password_token() -> str:
    """ POST /reset_password
    This method generates pswd reset token
